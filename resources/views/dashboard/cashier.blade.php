    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-md-4">
            <div class="stat-card tone-1">
                <div><div class="stat-label">Pending Total</div><div class="stat-value">${{ number_format($pendingTotal, 2) }}</div></div>
                <div class="stat-icon">💵</div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="stat-card tone-2">
                <div><div class="stat-label">Collected Today</div><div class="stat-value">${{ number_format($todayCollected, 2) }}</div></div>
                <div class="stat-icon">✅</div>
            </div>
        </div>
    </div>
